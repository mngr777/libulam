...
TOK("__CLASS_SIGNATURE__", __ClassSignature)
TOK("__CLASS_PRETTY__", __ClassPretty)
TOK("__CLASS_SIMPLE__", __ClassSimple)
TOK("__CLASS_MANGLED__", __ClassMangled)
TOK("__FUNC__", __Func)
