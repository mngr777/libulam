...
protected:
    ...
    void visit(ulam::Ref<ulam::ast::InitValue> node) override;
    void visit(ulam::Ref<ulam::ast::InitList> node) override;
    void visit(ulam::Ref<ulam::ast::InitMap> node) override;
    ...
    void visit(ulam::Ref<ulam::ast::Ternary> node) override;
